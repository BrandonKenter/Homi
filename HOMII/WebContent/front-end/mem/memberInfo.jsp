		...
		<div class="info-div">
			<div class="info-content">
				...
				<input type="radio" name="tabset" id="tab1"
						aria-controls="basic-info" checked> <label for="tab1">Basic Info</label>
				<input type="radio" name="tabset" id="tab2"
						aria-controls="payment-info" /> <label for="tab2">Payment</label>
					...
					<div class="row">
						<form method="post" class="col" id="user-info-form">
							<div class="user-pic">
								...
								<div class="user-infos">
									<label for="mb_name"><b>Name</b></label> <input class="input-disabled" 
										type="text" name="mb_name" id="mb_name"
										value="${memVO.mb_name}" maxlength="10" placeholder="Please enter name" 
										required disabled />
								</div>
								<div class="user-infos">
									<label for="mb_phone"><b>Phone</b></label> <input
										class="input-disabled" type="tel" inputmode="numeric"
										name="mb_phone" id="mb_phone" maxlength="30"
										value="${memVO.mb_phone}" placeholder="Please enter phone"  required disabled />
								</div>
								<div class="user-infos">
									<label for="mb_address"><b>Address</b></label> <input
										class="input-disabled" type="text" name="mb_address"
										id="mb_address" value="${memVO.mb_address}" maxlength="50"
										placeholder="Please enter rent address" required disabled />
								</div>
								<input style="display: none" value="${memVO.member_no}"
									name="mb_no">
								<div class="basic-info-buttons">
									<button type="button" class="btn btn-primary cancel-update1" style="display:none;">Cancel</button>
									&emsp;
									<button type="submit" class="btn btn-warning update-basic-info" style="display:none;">Apply</button>
								</div>
								<div class="basic-info-buttons">
									<button type="button" class="btn btn-secondary show-basic-update">Change Basic Info</button>
								</div>
						</form>
						
						<form method="post" class="col" id="account-info-form">
								<div class="user-infos">
									<label for="mb_status"><b>Account Activation</b></label>
									<c:choose>
										<c:when test="${memVO.status=='0'}">
											<input class="input-disabled" type="text" name="mb_status" id="mb_status" value="Not Activated" readonly />
										</c:when>
										<c:when test="${memVO.status=='1'}">
											<input class="input-disabled" type="text" name="mb_status" id="mb_status" value="Activated" readonly />
										</c:when>
										<c:otherwise>
											<input class="input-disabled" type="text" name="mb_status" id="mb_status" value="Invalid status" readonly />
										</c:otherwise>
									</c:choose>
								</div>
								<div class="user-infos">
									...
									<c:choose>
										<c:when test="${memVO.membership=='0'}">
											<input class="input-disabled" type="text" name="membership" id="membership" value="Tenant" readonly />
										</c:when>
										<c:when test="${memVO.membership=='1'}">
											<input class="input-disabled" type="text" name="membership" id="membership" value="Landlord" readonly />
										</c:when>
										<c:otherwise>
											<input class="input-disabled" type="text" name="membership" id="membership" value="Invalid membership" readonly />
										</c:otherwise>
									</c:choose>
								</div>
								<div style="display: none" class="password_reset">
									<label for="mb_name">Please enter your old password</label> 
								...
								<div style="display: none" class="password_reset">
									<label for="mb_name">Please enter your new password</label> <input
								...
								<div style="display: none" class="password_reset">
									<label for="mb_name">Confirm new password</label> <input
								...
								<input style="display: none;" value="${memVO.member_no}"
									name="mb_id">
								<div class="basic-info-buttons">
								 	<button type="button" class="btn btn-primary cancel-update2" >Cancel</button>
								 	&emsp;
								 	<button type="submit"class="btn btn-warning update-account-info">Apply</button>

								</div>
								<div class="basic-info-buttons">
									<button type="button" class="btn btn-secondary show-account-update">Change password</button>
								</div>
							</form>
...
$(document).ready(function () {
  ...
  $(document.body).on("click", ".delete-creditcard",function () { 
      ...
      Swal.fire({
          title: "Are you sure?",
          text: "You can't retreat your data",
          icon: "warning",
