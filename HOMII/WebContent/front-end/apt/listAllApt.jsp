...
if(pattern != null && pattern.equals("desc")){
	pageContext.setAttribute("listAllApt", aptSvc.getAllTop());
}else{
	pageContext.setAttribute("listAllApt", aptSvc.getAllBottom());
}
%>
<html>
<head>
<meta charset="UTF-8">
<title>More Apartments</title>
<style>
   body {  
...
<div style="text-align:center;"><h1 class="shadow p-3 mb-1 rounded" style="display:inline-block;">All the apartments</h1></div>
<table id="forum" class="table table-hover">
			 <thead style="background-color:#126E7D">
				...
				<c:forEach var="aptVO" items="${listAllApt}">		
					<tbody>
						<tr>
							<td>
